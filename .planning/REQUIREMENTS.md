...
- [ ] **FIL-01**: AI 助手可应用模糊与锐化滤镜 (高斯模糊、表面模糊、USM 锐化等)
- [ ] **FIL-02**: AI 助手可唤起并应用液化滤镜参数 (瘦脸、形体调整)
- [ ] **FIL-03**: AI 助手可调用 Camera Raw 滤镜进行专业后期套用
- [ ] **AI-01**: AI 助手可触发 Neural Filters (神经元滤镜)
- [ ] **AI-02**: AI 助手可自动执行经典商业磨皮动作流 (高反差保留+表面模糊)
- [ ] **AI-03**: AI 助手可触发生成式填充 (Generative Fill) 并传递提示词
