...
- [x] **SEL-01**: AI 助手可执行基础选区操作 (矩形、椭圆、全选、反选、取消)
- [x] **SEL-02**: AI 助手可修饰选区 (羽化、扩展、收缩、平滑、边界)
- [x] **SEL-03**: AI 助手可调用智能选择 (选择主体、移除背景、色彩范围)
- [x] **MASK-01**: AI 助手可控制图层蒙版 (添加、应用、删除、启用/禁用)
- [x] **CHAN-01**: AI 助手可控制通道 (载入为选区、选区存为通道)

### 专业调色与光影 (Color Correction)
- [x] **ADJ-01**: AI 助手可进行基础曝光调色 (亮度对比度、色阶、曲线、曝光度)
- [x] **ADJ-02**: AI 助手可进行基础色彩调色 (色相饱和度、色彩平衡、自然饱和度、黑白等)
- [x] **ADJ-03**: AI 助手可创建无损调整图层
- [x] **COL-01**: AI 助手可设置前景色/背景色 (HEX/RGB)
- [x] **COL-02**: AI 助手可执行填充与描边 (颜色填充、内容识别填充、描边)
...
- [x] **AUTO-01**: AI 助手可直接调用 PS 内部已录制好的动作集合 (Actions)
- [x] **AUTO-02**: AI 助手可加载并运行本地任意 `.jsx` 扩展脚本
- [x] **AUTO-03**: AI 助手可将设计图自动切片并导出 Web 所用格式
